...
function CheckAuthentication()
{
	...
	// return isset($_SESSION['IsAuthorized']) && $_SESSION['IsAuthorized'];$userName = $this->session->userdata('userName');
...
$config['ResourceType'][] = Array(
		...
		'url' => $baseUrl . 'pdfDirectory',
		'directory' => $baseDir . 'pdfDirectory',
		'maxSize' => 0,
...
$config['ResourceType'][] = Array(
		...
		'maxSize' => 0,
		'allowedExtensions' => 'swf,flv, mp4,webm',
		'deniedExtensions' => '');
