...
class WPEX_Welcome {
			...
			<div>
				<div class="feature-section">
					...
					<div>
						...
						<a href="http://www.wpexplorer.com/blogger-free-wordpress-theme/" target="_blank" class="button button-primary"><?php _e('Theme Page','wpex'); ?></a>
	...
	public function welcome() {
		...
		if ( is_admin() && isset( $_GET['activated'] ) && $pagenow == 'themes.php' ) {
			wp_safe_redirect( admin_url( 'admin.php?page=wpex-about' ) );
			exit;
		}
	}
}
